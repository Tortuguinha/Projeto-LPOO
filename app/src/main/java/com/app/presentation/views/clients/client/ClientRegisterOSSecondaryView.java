...
public class ClientRegisterOSSecondaryView extends JFrame {
	...
	public ClientRegisterOSSecondaryView(ServiceOrderEntity serviceOrder) {
        ...
        finishBtn.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		clientController.createOS(serviceOrder);
        	}
        });
