...
public class CompanyRegisterOSView extends JFrame {
	...
	private void initialize() {
		...
		cnpjLabel.setBounds(10, 36, 152, 14);
		frame.getContentPane().add(cnpjLabel);
		
		cnpjField = new JTextField();
		cnpjField.setBounds(10, 61, 179, 31);
		frame.getContentPane().add(cnpjField);
		...
		nextButton.setForeground(SystemColor.textHighlight);
		...
		nextButton.setBounds(546, 329, 130, 33);
