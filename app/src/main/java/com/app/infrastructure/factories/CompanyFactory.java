...
public class CompanyFactory {
	...
	public static ICompanyController getInstance() {
		if(instance == null) {
	         ...
	         RegisterCompanyOSUseCase registerCompanyOSUseCase = new RegisterCompanyOSUseCase(companyRepository);

	         CompanyService companyService = new CompanyService(registerCompanyUseCase, returnCompanyUseCase, registerCompanyOSUseCase);
